defmodule Rumbl.MultimediaTest do
  ...
  describe "videos" do
    ...
    @valid_attrs %{description: "some desc", title: "some title", url: "http://local"}
    ...
    test "get_video!/1 return video with given id" do
      owner = user_fixture()
    ...
    test "create_video/2 with valid data creates a video" do
      ...
      assert video.description == "some desc"
    ...
    test "change_video/0 returns a changeset" do
      owner = user_fixture()
      video = video_fixture(owner)
